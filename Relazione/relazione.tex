...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/401.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/403.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/404.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/500.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/registrazione.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/accesso.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/areaPersonale.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/elencoClienti.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/lighthouse.png}}
	\caption{Schermata iniziale di Lighthouse}
\end{figure}
\subsubsection*{Silktide}
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/silktide.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[scale=0.7]{./graphics/nvda.png}}
	\caption{Logo di NVDA}
\end{figure}
\subsubsection*{Links}
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/links.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=\textwidth]{./graphics/xampp.jpg}}
