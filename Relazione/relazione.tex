...
%TODO mettere immagine per mobile
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.8\textwidth}
	  \centering
	  \fbox{\includegraphics[width=1\textwidth]{./graphics/NirvanaTrattamentiViso-w.pdf}}
	  \caption{Stampa con grafica di background}
	\end{subfigure}
	\begin{subfigure}[t]{0.8\textwidth}
	  \centering
	  \fbox{\includegraphics[width=1\textwidth]{./graphics/NirvanaTrattamentiViso-wo.pdf}}
...
\subsubsection{HTML}	%TODO Annalisa e Matteo
...
\subsubsection{PHP} %TODO Matteo e Nicola
\subsubsection{SQL}	%TODO Nicola
\subsubsection{JavaScript} %TODO Lisien
