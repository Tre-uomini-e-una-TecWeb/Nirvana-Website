...
L'utente generico può entrare nella pagina \textit{Trattamenti Viso} attraverso le apposite voci presenti sia nel menú sia nella pagina Trattamenti e Macchinari.\\
...
L'utente generico può entrare nella pagina \textit{Trattamenti Corpo} attraverso le apposite voci presenti sia nel menú sia nella pagina Trattamenti e Macchinari.\\
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item CSS: Implementazioni sui fogli relativi alla visualizzazione desktop e mobile, oltre alle modifiche sul foglio per la stampa
		\item Javascript:
		\item PHP:
		\item Immagini:
		\item Relazione:
