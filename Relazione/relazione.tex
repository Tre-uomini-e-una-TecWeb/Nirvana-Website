...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[scale=0.39]{./graphics/dual-page.pdf}}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Test: test su Safari Desktop (macOS), Safari Mobile (iOS), Microsoft Edge (Windowa), Google Chrome Desktop (macOS e Windows), Google Chrome Mobile (iOS).
	\end{itemize} 
	\item Nicola Baesso:
	\begin{itemize}
