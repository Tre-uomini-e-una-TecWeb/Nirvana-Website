...
%struttura delle pagine
	% pagine semplici
	% pagine con card --> carte link o carte semplici
	% pagine divise in due
%mettere immagini (una per sezione)

%% Matteo, Annalisa
\subsection{Mobile}
Il fogli di stile relativo a dispositivi mobili viene utilizzato quando la larghezza di schermo offerta per la visualizzazione dei contenuti è inferiore a 1150 pixels: tale misura è stata scelta in modo sperimentale, basandosi inizialmente sulla larghezza della breadcrumb più verbosa.\\
